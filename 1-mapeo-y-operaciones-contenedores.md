...
El comando ls en sistemas basados en Unix/Linux se usa para listar los archivos y directorios dentro de un directorio.
### ¿Para qué sirve el argumento -l junto al comando ls?
Muestra una lista detallada de archivos y directorios, incluyendo información como permisos, propietario, grupo, tamaño y fecha de modificación.
...
```
Paso 2: Ingresar dirección /var/jenkins_home/secrets/initialAdminPassword
```
